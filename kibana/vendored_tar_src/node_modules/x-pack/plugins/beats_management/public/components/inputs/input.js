...
class FieldText extends react_1.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return (react_1.default.createElement(eui_1.EuiFormRow, { id: id, label: label, helpText: helpText, isInvalid: !disabled && error, error: !disabled && error ? getErrorMessage() : [] },
            react_1.default.createElement(eui_1.EuiFieldText, { id: id, name: name, placeholder: placeholder, value: getValue() || '', isInvalid: !disabled && error, onChange: this.handleChange, onBlur: this.handleBlur, fullWidth: fullWidth, disabled: disabled, required: required, className: className })));
    }
}
FieldText.defaultProps = {
    passRequiredToField: true,
};
exports.FormsyEuiFieldText = formsy_react_1.withFormsy(FieldText);
