...
MASTER_RELEASE_VERSION=${MASTER_RELEASE_VERSION:-4.8}
get_cluster_version_maj_min
# what numeric version does master correspond to?
MASTER_VERSION=${MASTER_VERSION:-${CLUSTER_MAJ_MIN:-4.8}}
...
export LOGGING_VERSION=${LOGGING_VERSION:-5.3}

export LOGGING_FLUENTD_VERSION=${LOGGING_FLUENTD_VERSION:-1.7.4}
export LOGGING_LOG_FILE_METRIC_EXPORTER_VERSION=${LOGGING_LOG_FILE_METRIC_EXPORTER_VERSION:-1.0}
...
#openshift images
export IMAGE_KUBE_RBAC_PROXY=${IMAGE_KUBE_RBAC_PROXY:-registry.ci.openshift.org/ocp/${MASTER_VERSION}:kube-rbac-proxy}
export IMAGE_OAUTH_PROXY=${IMAGE_OAUTH_PROXY:-registry.ci.openshift.org/ocp/${MASTER_VERSION}:oauth-proxy}

#logging registry images
...
export IMAGE_ELASTICSEARCH_OPERATOR_REGISTRY=${IMAGE_ELASTICSEARCH_OPERATOR_REGISTRY:-quay.io/${LOGGING_IS}/elasticsearch-operator-registry:${LOGGING_VERSION}}
