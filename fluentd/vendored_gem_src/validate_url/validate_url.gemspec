...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md".freeze, "README.md".freeze, "init.rb".freeze, "install.rb".freeze, "lib/locale/de.yml".freeze, "lib/locale/en.yml".freeze, "lib/locale/fr.yml".freeze, "lib/locale/it.yml".freeze, "lib/locale/ja.yml".freeze, "lib/locale/km.yml".freeze, "lib/locale/pl.yml".freeze, "lib/locale/pt-BR.yml".freeze, "lib/locale/ro.yml".freeze, "lib/locale/ru.yml".freeze, "lib/locale/tr.yml".freeze, "lib/locale/zh-CN.yml".freeze, "lib/locale/zh-TW.yml".freeze, "lib/rspec_matcher.rb".freeze, "lib/validate_url.rb".freeze]
