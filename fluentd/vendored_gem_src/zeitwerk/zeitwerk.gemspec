...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE".freeze, "README.md".freeze, "lib/zeitwerk.rb".freeze, "lib/zeitwerk/error.rb".freeze, "lib/zeitwerk/explicit_namespace.rb".freeze, "lib/zeitwerk/gem_inflector.rb".freeze, "lib/zeitwerk/inflector.rb".freeze, "lib/zeitwerk/kernel.rb".freeze, "lib/zeitwerk/loader.rb".freeze, "lib/zeitwerk/loader/callbacks.rb".freeze, "lib/zeitwerk/real_mod_name.rb".freeze, "lib/zeitwerk/registry.rb".freeze, "lib/zeitwerk/version.rb".freeze]
